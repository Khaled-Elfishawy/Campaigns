    ...
    function scope(target, options, originalOptions) {
        ...
        function tooltips() {
            ...
            bindEvent("update", function(values, handleNumber, unencoded) {
                ...
                var formattedValue = parseInt(values[handleNumber]);
                ...
                spanFirst.innerHTML = '$ ';
                spanSecond.innerHTML = formattedValue;
                pBottom.appendChild(spanFirst);
                pBottom.appendChild(spanSecond);
                wrapper.appendChild(pBottom);
                tips[handleNumber].innerHTML = '';
                tips[handleNumber].appendChild(wrapper);
            });
        }
